...
// mocha --opts test/mocha.opts -g prototype test/splitter_test.js
...
suite('splitter', () => {
  ...
  test('should validate enums correctly with extra spaces', () => {
    var splitter = new Splitter('enumeration', enums);
    // inspect(splitter._enumIds);
    var result = splitter.validate(`ACCOMACK, Virginia\tADA, Idaho\t17001\tdog`, ['NEWLINE', 'TABULATOR']);
    assert.deepEqual({
      valid: 3,
      invalid: 1
    }, result);
  ...
  test('should validate integer with all delimiters', () => {
    ...
    // inspect(splitter._enumIds);
    var result = splitter.validate(`1,2;3 4\t5\r\n6`, ['COMMA', 'SEMICOLON', 'SPACE', 'TABULATOR', 'NEWLINE']);
    assert.deepEqual({
      valid: 6,
      invalid: 0
    }, result);
  ...
  test('should validate DATE_AND_TIME with all delimiters', () => {
    ...
    var result = splitter.validate('1999-12-25 12:25:25,1999-12-26 12:25:25;1999-12-27 12:25:25' +
      '\t1999-12-28 12:25:25\r\n1999-12-29 12:25:25', ['COMMA', 'SEMICOLON', 'TABULATOR', 'NEWLINE']);
    assert.deepEqual({
      valid: 5,
      invalid: 0
    }, result);
